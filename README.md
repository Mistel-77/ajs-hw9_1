# ajs-hw9_1
Домашнее задание к лекции «Math, Regexp, ArrayBuffer» Math (log/trig)

[![Build status](https://ci.appveyor.com/api/projects/status/fcnq06iwwnkin5dg/branch/master?svg=true)](https://ci.appveyor.com/project/Mistel-77/ajs-hw9-1/branch/master)
